...
class AuthProvider with ChangeNotifier {
  ...
  /// Update the display name in memory and persist it to storage.
  Future<void> updateName(String name) async {
    _name = name;
    await _storage?.writeUserName(name);
    notifyListeners();
  }
  ...
  Future<void> initializeAuth() async {
    ...
    // Load cached name and profile data
    _name = await _storage.readUserName();
  ...
  Future<void> _handleAuthSuccess(Map<String, dynamic> data, String email) async {
    ...
    if (_token != null && _profileApi != null && _storage != null) {
      try {
